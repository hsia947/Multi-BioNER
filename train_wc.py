...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_file', nargs='+', default=["data_bioner_5/BC2GM-IOBES/merge.tsv"], help='path to training file')
    parser.add_argument('--dev_file', nargs='+', default=["data_bioner_5/BC2GM-IOBES/devel.tsv"], help='path to development file')
    parser.add_argument('--test_file', nargs='+', default=["data_bioner_5/BC2GM-IOBES/test.tsv"], help='path to test file')
